...
description: Legacy prompt retained for historical context. GitHub PR operations now run via slash commands executed by the build or sdlc primary agents.
